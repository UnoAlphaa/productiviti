import { ArrowLeftIcon, FileTextIcon, ImageIcon, SaveIcon, TypeIcon } from 'lucide-react';
        ...
        <div className='card bg-base-300'>
            <div className='card-body'>
                <div className='card-title'>
                    <SaveIcon className='size-5 text-primary' /> Edit Product
                </div>
                ...
                >
                    ...
                    <label className='flex items-center bg-base-200 gap-2 input input-bordered'>
                    ...
                    {formData.imageUrl && (
                        <div className='rounded-box overflow-hidden'>
                            <img 
                            src={formData.imageUrl} alt={formData.title}
